# Catálogo bilíngue de letras — KTD
...
|---:|---|---|---|---|
| 1 | *Unleash the Dragon* | [`ktd-debut-single-lyrics.md`](../ktd-debut-single-lyrics.md) | [`single-1-unleash-the-dragon-lyrics-pt-br.md`](pt-br/single-1-unleash-the-dragon-lyrics-pt-br.md) | Fonte inglesa preservada; letra de referência do catálogo inicial |
| 2 | *Six Names* | [`ktd-launch-playlist-lyrics.md`](../ktd-launch-playlist-lyrics.md), seção 02 | [`single-2-six-names-lyrics-pt-br.md`](pt-br/single-2-six-names-lyrics-pt-br.md) | Fonte inglesa preservada; letra de referência da playlist de lançamento |
| 3 | *Golden Scars* | [`ktd-launch-playlist-lyrics.md`](../ktd-launch-playlist-lyrics.md), seção 03 | [`single-3-golden-scars-lyrics-pt-br.md`](pt-br/single-3-golden-scars-lyrics-pt-br.md) | Fonte inglesa preservada; letra de referência da playlist de lançamento |
| 4 | *Pressure Speaks* | [`single-4-pressure-speaks-lyrics-essence-v1.md`](single-4-pressure-speaks-lyrics-essence-v1.md) | [`single-4-pressure-speaks-lyrics-pt-br.md`](pt-br/single-4-pressure-speaks-lyrics-pt-br.md) | Áudio e direção aprovados como **MAGNÍFICO**; inglês é a fonte oficial |
| 5 | *No More Quiet Cries* | [`single-5-no-more-quiet-cries-lyrics-v1.md`](single-5-no-more-quiet-cries-lyrics-v1.md) | [`single-5-no-more-quiet-cries-lyrics-pt-br.md`](pt-br/single-5-no-more-quiet-cries-lyrics-pt-br.md) | Versão v1 aprovada como **EXTRAORDINÁRIO**; inglês é a fonte oficial |
| 6 | *The Dragon Remembers* | [`single-6-the-dragon-remembers-lyrics-v1.md`](single-6-the-dragon-remembers-lyrics-v1.md) | [`single-6-the-dragon-remembers-lyrics-pt-br.md`](pt-br/single-6-the-dragon-remembers-lyrics-pt-br.md) | Letra candidata para avaliação do primeiro demo |
...
O Single 7 possui o suplemento [`single-7-no-one-saved-me-a-seat-chorus-v4-gospel.md`](single-7-no-one-saved-me-a-seat-chorus-v4-gospel.md), que documenta o refrão gospel aprovado. Esse arquivo é uma direção específica do refrão e não substitui a letra completa em inglês nem a tradução brasileira integral.

O Single 8 possui o registro de aprovação [`single-8-build-the-door-behind-me-approval-v1.md`](single-8-build-the-door-behind-me-approval-v1.md), que mantém a v1 como versão oficial e arquiva a v2 para comparação.

O Single 9 possui o registro de aprovação [`single-9-you-came-back-when-i-won-approval-v1.md`](single-9-you-came-back-when-i-won-approval-v1.md), que mantém a v1 como única versão aprovada e marca a Prova 4 como reprovada.
