...
O rework principal está em **FIRE IN THE FLOOD**. O conceito e a arquitetura estão em [`docs/ktd-main-single-rework-concept.md`](docs/ktd-main-single-rework-concept.md), a letra inédita em [`docs/ktd-main-single-rework-lyrics.md`](docs/ktd-main-single-rework-lyrics.md), a análise abstrata da referência em [`docs/ktd-main-single-reference-analysis.md`](docs/ktd-main-single-reference-analysis.md) e o registro de produção em [`docs/ktd-main-single-fire-in-the-flood-production.md`](docs/ktd-main-single-fire-in-the-flood-production.md). A prova de arranjo está em [`assets/audio/releases/ktd-main-single-fire-in-the-flood-official-vocal-arrangement-proof-v1.mp3`](assets/audio/releases/ktd-main-single-fire-in-the-flood-official-vocal-arrangement-proof-v1.mp3), com base inédita e master WAV correspondentes. Ela é uma versão original de produção, pendente de nova tomada vocal da letra reescrita. As tentativas de geração neural integral com a nova letra não produziram uma tomada vocal confiável; por isso, o resultado atual é uma prova de composição, arranjo e pocket com a voz oficial, não um master final anunciado como lançamento.
