...
Para corrigir o encaixe rítmico, foi criada uma versão **reference-fit** em 136 BPM com leitura halftime de 68 BPM, snare como âncora, 808 sincronizado ao kick, hats reduzidos sob as frases e ducking sidechain no instrumental. O diagnóstico está em [`docs/ktd-fire-in-the-flood-rhythm-reference-analysis.md`](docs/ktd-fire-in-the-flood-rhythm-reference-analysis.md), o registro técnico em [`docs/ktd-fire-in-the-flood-reference-fit-production.md`](docs/ktd-fire-in-the-flood-reference-fit-production.md), a base em [`assets/audio/releases/ktd-main-single-fire-in-the-flood-beat-reference-fit-v3.wav`](assets/audio/releases/ktd-main-single-fire-in-the-flood-beat-reference-fit-v3.wav) e a nova mixagem em [`assets/audio/releases/ktd-main-single-fire-in-the-flood-reference-fit-v1.mp3`](assets/audio/releases/ktd-main-single-fire-in-the-flood-reference-fit-v1.mp3). A letra e a melodia não foram alteradas; esta é uma prova de encaixe e mixagem, pendente de aprovação humana. As tentativas de geração neural integral com a nova letra não produziram uma tomada vocal confiável; por isso, o resultado atual é uma prova de composição, arranjo e pocket com a voz oficial, não um master final anunciado como lançamento.
