...
A mix aprovada humanamente por KTD nesta etapa é [`assets/audio/releases/ktd-main-single-fire-in-the-flood-v1-reference-aligned-mix-v3.mp3`](assets/audio/releases/ktd-main-single-fire-in-the-flood-v1-reference-aligned-mix-v3.mp3), com master WAV em [`assets/audio/releases/ktd-main-single-fire-in-the-flood-v1-reference-aligned-mix-v3.wav`](assets/audio/releases/ktd-main-single-fire-in-the-flood-v1-reference-aligned-mix-v3.wav). Ela preserva a letra e a melodia de fundo aprovadas e usa um groove original alinhado à grade temporal da V1. A cadeia e o registro da aprovação estão em [`docs/ktd-fire-in-the-flood-v1-reference-aligned-mix-v3-production.md`](docs/ktd-fire-in-the-flood-v1-reference-aligned-mix-v3-production.md).
