...
O rework principal está em **FIRE IN THE FLOOD**. O conceito e a arquitetura estão em [`docs/ktd-main-single-rework-concept.md`](docs/ktd-main-single-rework-concept.md), a letra inédita em [`docs/ktd-main-single-rework-lyrics.md`](docs/ktd-main-single-rework-lyrics.md), a análise abstrata da referência em [`docs/ktd-main-single-reference-analysis.md`](docs/ktd-main-single-reference-analysis.md) e o registro de produção em [`docs/ktd-main-single-fire-in-the-flood-production.md`](docs/ktd-main-single-fire-in-the-flood-production.md). A prova de arranjo original está em [`assets/audio/releases/ktd-main-single-fire-in-the-flood-official-vocal-arrangement-proof-v1.mp3`](assets/audio/releases/ktd-main-single-fire-in-the-flood-official-vocal-arrangement-proof-v1.mp3), com base inédita e master WAV correspondentes. Ela é uma versão original de produção, pendente de nova tomada vocal da letra reescrita.

Para corrigir o encaixe rítmico, foi criada uma versão **reference-fit** em 136 BPM com leitura halftime de 68 BPM, snare como âncora, 808 sincronizado ao kick, hats reduzidos sob as frases e ducking sidechain no instrumental. O diagnóstico está em [`docs/ktd-fire-in-the-flood-rhythm-reference-analysis.md`](docs/ktd-fire-in-the-flood-rhythm-reference-analysis.md), e o registro técnico em [`docs/ktd-fire-in-the-flood-reference-fit-production.md`](docs/ktd-fire-in-the-flood-reference-fit-production.md).

A correção definitiva desta etapa está documentada em [`docs/ktd-fire-in-the-flood-v1-rebeat-production.md`](docs/ktd-fire-in-the-flood-v1-rebeat-production.md). A melodia V1 congelada está formalizada em [`docs/ktd-fire-in-the-flood-v1-melody-lock.md`](docs/ktd-fire-in-the-flood-v1-melody-lock.md). O stem técnico preservando a V1 está em `assets/audio/releases/ktd-main-single-fire-in-the-flood-v1-vocal-isolated-stem-v1.wav`; o novo acompanhamento está em `assets/audio/releases/ktd-main-single-fire-in-the-flood-beat-reference-fit-v3.wav`; e a mix corrigida, com a V1 intacta sobre o novo beat, está em [`assets/audio/releases/ktd-main-single-fire-in-the-flood-v1-rebeat-v1.mp3`](assets/audio/releases/ktd-main-single-fire-in-the-flood-v1-rebeat-v1.mp3), com WAV correspondente. **Nenhuma melodia, letra ou hook foi alterado.** As tentativas de geração neural integral com a nova letra não produziram uma tomada vocal confiável; por isso, o resultado atual é uma prova de composição, arranjo e pocket com a voz oficial, não um master final anunciado como lançamento.
