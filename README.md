...
A nova identidade vocal do Káiros está descrita em [`personas/artist-principal/voice-profile.md`](personas/artist-principal/voice-profile.md). A demo primária cantada em inglês está em [`assets/audio/kairos-voice-direction-demo-en-v2.mp3`](assets/audio/kairos-voice-direction-demo-en-v2.mp3), com rap mais agressivo e direto, ataques secos, poesia confrontadora, sofrimento audível e uma coloração roots/dub original. A versão anterior está preservada para comparação, assim como a primeira amostra falada em português em [`assets/audio/artista-principal-voz-demo.wav`](assets/audio/artista-principal-voz-demo.wav).
